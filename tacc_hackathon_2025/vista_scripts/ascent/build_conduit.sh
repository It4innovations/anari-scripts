...
output=${ROOT_DIR}/install/conduit
src=${ROOT_DIR}/src
...
# rm -rf ${ROOT_DIR}/build/conduit
# rm -rf ${ROOT_DIR}/install/conduit

#-----------blender_client--------------
mkdir ${ROOT_DIR}/build/conduit
cd ${ROOT_DIR}/build/conduit

make_d="${src}/conduit/src"
...
# make_d="${make_d} -DENABLE_FORTRAN=ON"
