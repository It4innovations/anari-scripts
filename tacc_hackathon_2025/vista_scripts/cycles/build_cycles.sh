...
#######################GIT#################################
#cd src
#git clone https://github.com/it4innovations/cyclesphi.git
##################Karolina################################
...
output=${ROOT_DIR}/install/cycles
src=${ROOT_DIR}/src
...
# rm -rf ${ROOT_DIR}/build/cycles
# rm -rf ${ROOT_DIR}/install/cycles

#-----------blender_client--------------
mkdir ${ROOT_DIR}/build/cycles
cd ${ROOT_DIR}/build/cycles
...
make_d="${make_d} -DWITH_CYCLES_OPENVDB=OFF"
make_d="${make_d} -DWITH_CYCLES_USD=OFF"
make_d="${make_d} -DWITH_CYCLES_NANOVDB=OFF"
